...
import { Search, Truck, Shield, CreditCard, ArrowRight, Zap, ChevronRight, Volume2, VolumeX } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section ref={heroRef} className="relative overflow-hidden min-h-[70vh] flex items-center">
        <motion.div
          style={{ y: heroY }}
          className="absolute inset-0 w-full h-full bg-gradient-to-br from-primary/20 to-foreground scale-110"
        />
        ...
        <motion.div style={{ opacity: heroOpacity }} className="container py-16 md:py-28 px-6 relative z-10 text-primary-foreground">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-muted-foreground text-lg md:text-xl mb-10 font-medium max-w-xl">
              Repuestos de calidad para tu moto. Envíos a todo el país con la garantía de @gos_motos.
            </motion.p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {featured.length > 0 ? (
                ...
                <div className="col-span-full py-20 text-center border-2 border-dashed border-muted/30 rounded-[3rem]">
                  <p className="text-muted-foreground font-bold uppercase tracking-widest">Nuevas ofertas próximamente...</p>
                </div>
              )}
            </div>
          )}
