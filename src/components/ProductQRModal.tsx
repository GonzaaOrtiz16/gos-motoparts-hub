      ...
      <DialogContent className="max-w-sm rounded-[24px] p-0 overflow-hidden">
        <div className="bg-card p-6 space-y-5">
          ...
          <div className="text-center space-y-1">
            <p className="font-black uppercase text-sm tracking-tight leading-tight">{displayTitle}</p>
            <p className="text-2xl font-black text-primary italic">{formatPrice(product.price)}</p>
            <p className="text-[10px] text-muted-foreground font-bold font-mono">{product.barcode}</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
